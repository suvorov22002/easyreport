Liferay.Loader.define("easyreport@0.0.0/index", ['module', 'exports', 'require', './easyreport/polyfills', './easyreport/runtime', './easyreport/main', './adapt-rt'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    const polyfills = require("./easyreport/polyfills");
    const runtime = require("./easyreport/runtime");
    const main = require("./easyreport/main");
